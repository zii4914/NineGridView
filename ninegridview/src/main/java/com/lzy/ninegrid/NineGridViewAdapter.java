...
public abstract class NineGridViewAdapter implements Serializable {
   ...
   */
  protected NineGridViewWrapper generateItemView(Context context) {
    NineGridViewWrapper wrapper = new NineGridViewWrapper(context);
    GradientDrawable drawable = new GradientDrawable();
    drawable.setColor(Color.parseColor("#33000000"));

    ImageView ivSrc = wrapper.getIvSrc();
    ivSrc.setScaleType(ImageView.ScaleType.CENTER_CROP);
    ivSrc.setImageDrawable(drawable);
    return wrapper;
  }
